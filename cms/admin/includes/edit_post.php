...
if (isset($_POST['update_post'])){
    ...
    $query = "UPDATE posts SET author = '$author', post_title = '$post_title', post_category_id = '$post_category_id', post_tags = '$post_tags', post_status = '$post_status', post_image = '$post_image', post_content = '$post_content', post_date = now(), comment_count = '$comment_count' WHERE post_id = {$the_post_id} ";
